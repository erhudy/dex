...
var file_api_v2_api_proto_rawDesc = []byte{
	...
	0x74, 0x46, 0x6f, 0x75, 0x6e, 0x64, 0x32, 0x98, 0x08, 0x0a, 0x03, 0x44, 0x65, 0x78, 0x12, 0x34,
	0x0a, 0x09, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x12, 0x11, 0x2e, 0x61, 0x70,
	0x69, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65, 0x71, 0x1a, 0x12,
	0x2e, 0x61, 0x70, 0x69, 0x2e, 0x47, 0x65, 0x74, 0x43, 0x6c, 0x69, 0x65, 0x6e, 0x74, 0x52, 0x65,
	0x73, 0x70, 0x22, 0x00, 0x12, 0x3d, 0x0a, 0x0c, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x43, 0x6c,
...
var file_api_v2_api_proto_msgTypes = make([]protoimpl.MessageInfo, 37)
var file_api_v2_api_proto_goTypes = []interface{}{
	...
	(*CreateConnectorReq)(nil),  // 20: api.CreateConnectorReq
	(*CreateConnectorResp)(nil), // 21: api.CreateConnectorResp
	(*UpdateConnectorReq)(nil),  // 22: api.UpdateConnectorReq
	(*UpdateConnectorResp)(nil), // 23: api.UpdateConnectorResp
	(*DeleteConnectorReq)(nil),  // 24: api.DeleteConnectorReq
	(*DeleteConnectorResp)(nil), // 25: api.DeleteConnectorResp
	(*ListConnectorReq)(nil),    // 26: api.ListConnectorReq
	(*ListConnectorResp)(nil),   // 27: api.ListConnectorResp
	(*VersionReq)(nil),          // 28: api.VersionReq
	(*VersionResp)(nil),         // 29: api.VersionResp
	(*RefreshTokenRef)(nil),     // 30: api.RefreshTokenRef
	(*ListRefreshReq)(nil),      // 31: api.ListRefreshReq
	(*ListRefreshResp)(nil),     // 32: api.ListRefreshResp
	(*RevokeRefreshReq)(nil),    // 33: api.RevokeRefreshReq
	(*RevokeRefreshResp)(nil),   // 34: api.RevokeRefreshResp
	(*VerifyPasswordReq)(nil),   // 35: api.VerifyPasswordReq
	(*VerifyPasswordResp)(nil),  // 36: api.VerifyPasswordResp
}
var file_api_v2_api_proto_depIdxs = []int32{
	...
	19, // 7: api.CreateConnectorReq.connector:type_name -> api.Connector
	19, // 8: api.ListConnectorResp.connectors:type_name -> api.Connector
	30, // 9: api.ListRefreshResp.refresh_tokens:type_name -> api.RefreshTokenRef
	...
	20, // 18: api.Dex.CreateConnector:input_type -> api.CreateConnectorReq
	22, // 19: api.Dex.UpdateConnector:input_type -> api.UpdateConnectorReq
	24, // 20: api.Dex.DeleteConnector:input_type -> api.DeleteConnectorReq
	26, // 21: api.Dex.ListConnectors:input_type -> api.ListConnectorReq
	28, // 22: api.Dex.GetVersion:input_type -> api.VersionReq
	31, // 23: api.Dex.ListRefresh:input_type -> api.ListRefreshReq
	33, // 24: api.Dex.RevokeRefresh:input_type -> api.RevokeRefreshReq
	35, // 25: api.Dex.VerifyPassword:input_type -> api.VerifyPasswordReq
	3,  // 26: api.Dex.GetClient:output_type -> api.GetClientResp
	5,  // 27: api.Dex.CreateClient:output_type -> api.CreateClientResp
	9,  // 28: api.Dex.UpdateClient:output_type -> api.UpdateClientResp
	7,  // 29: api.Dex.DeleteClient:output_type -> api.DeleteClientResp
	12, // 30: api.Dex.CreatePassword:output_type -> api.CreatePasswordResp
	14, // 31: api.Dex.UpdatePassword:output_type -> api.UpdatePasswordResp
	16, // 32: api.Dex.DeletePassword:output_type -> api.DeletePasswordResp
	18, // 33: api.Dex.ListPasswords:output_type -> api.ListPasswordResp
	21, // 34: api.Dex.CreateConnector:output_type -> api.CreateConnectorResp
	23, // 35: api.Dex.UpdateConnector:output_type -> api.UpdateConnectorResp
	25, // 36: api.Dex.DeleteConnector:output_type -> api.DeleteConnectorResp
	27, // 37: api.Dex.ListConnectors:output_type -> api.ListConnectorResp
	29, // 38: api.Dex.GetVersion:output_type -> api.VersionResp
	32, // 39: api.Dex.ListRefresh:output_type -> api.ListRefreshResp
	34, // 40: api.Dex.RevokeRefresh:output_type -> api.RevokeRefreshResp
	36, // 41: api.Dex.VerifyPassword:output_type -> api.VerifyPasswordResp
